...
public class MenuStateMachine : MonoBehaviour {
    ...
    public GameObject screenWithoutAds;
    public GameObject[] TutCalender;

    public GameObject CreditPanel;
//    public Text bestScore;
    public static int levSequence;
    ...
    ///
     ...
     public void  clickButton( int levSeq)
    {

        Debug.Log("ClickButton....");
        levSequence = levSeq;
        SetupTutorial();
        //if (TestAds.adStatus != 2)
        //{
        //    AdsShow();
        //}
        //else
     ...
     IEnumerator isAdsShowing()
     {
         yield return new WaitForSeconds(0);
         while (Advertisement.isShowing==true)
         {
             yield return null;
         }
       //  CancelInvoke("Ads Remove");
         StopCoroutine(isAdsShowing());
         SetupTutorial();
	...
	void SetupTutorial() {
        TutCalender[0].SetActive(true);
        TutCalender[1].SetActive(true);
        ScoreManager.total = 0;
        //if (levSequence == 0)
        //{
        //    bestScore.text = PlayerPrefs.GetInt("7") + "";
        //    Debug.Log("Score :" + PlayerPrefs.GetInt("7"));
        //}
        //else if (levSequence == 1)
        //{
        //    bestScore.text = PlayerPrefs.GetInt("14") + "";
        //}
        //else if (levSequence == 2)
        //{
        //    bestScore.text = PlayerPrefs.GetInt("28") + "";
        //}
		...
		if(useTut) {
            ...
            TutCalender[0].SetActive(false);
            TutCalender[1].SetActive(false);
    ...
    public void FirstPlay(GameObject chooseTrip)
    {
    ...
    //Credit
    public void onCrditButton()
    {
        CreditPanel.SetActive(true);
    }
    public void onCrditCancelButton()
    {
