...
public class UnityIAP : MonoBehaviour, IStoreListener
{
    ...
    public static UnityIAP Instance { set; get; }
    private static IStoreController m_StoreController;          // The Unity Purchasing system.
    private static IExtensionProvider m_StoreExtensionProvider; // The store-specific Purchasing subsystems.
   
    public static string kProductIDConsumable = "100gold";
    public static string kProductIDNonConsumable = "com.clownboxgames.harpoonlagoon.removeads";
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, kProductIDNonConsumable, StringComparison.Ordinal))
        {
           // PlayerPrefs.SetInt("Status", 2);
            ...
            Debug.Log(" Ads Remove : " + kProductIDNonConsumable);
